...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm">
      ...
      <h2>Solution</h2>
      <p>The <em>Science Intranet</em> was the result of many feedback sessions, surveys and user experience meetings with faculty and staff from every department in Science. A customized Google Site in-line with the institutional look and feel allowed multiple contributors from various groups in the Dean's office to easily update content. As well, having this space gave the Associate Deans a place to record procedures and processes, allowing for greater continuity as roles changed.</p>
      <h2>Highlights</h2>
      <p><strong>Single contact list</strong></p>
      <ul>
        <li>Updating the master contact list (in Google Sheets) would push the changes throughout the <em>Science Intranet</em></li>
      ...
      <p><strong>Dean's office portfolios</strong></p>
      <ul>
        <li>Each portfolio in the dean's office was given its own section on the <em>Science Intranet</em> to more clearly communicate their role and quickly disseminate any updates</li>
      </ul>
      <br />
    </div>
  </div>
